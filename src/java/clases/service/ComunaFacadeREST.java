...
public class ComunaFacadeREST {
    ...
    public Response create(@PathParam("desc") String desc, @PathParam("region") Long region) {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_COMUNA.MODIFICAR")
    ...
    @Path("{id}/{desc}/{region}")
    @Consumes({MediaType.APPLICATION_JSON})
    public Response edit(@PathParam("id") Long id, @PathParam("desc") String desc, @PathParam("region") Long region) {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_COMUNA.MODIFICAR")
    ...
    public Response remove(@PathParam("id") Long id) {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_COMUNA.ELIMINAR")
                .registerStoredProcedureParameter(1, Long.class,
                        ParameterMode.IN)
    ...
    public Response find(@PathParam("id") Long id) {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_COMUNA.FIND")
                .registerStoredProcedureParameter(1, Long.class,
                        ParameterMode.IN)
                .registerStoredProcedureParameter(2, Class.class,
    ...
    @Path("Region/{id}")
    @Produces({MediaType.APPLICATION_JSON})
    public Response Region(@PathParam("id") Long id) {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_COMUNA.REGION")
                .registerStoredProcedureParameter(1, Long.class,
                        ParameterMode.IN)
                .registerStoredProcedureParameter(2, Class.class,
                        ParameterMode.REF_CURSOR)
    ...
    public Response findAll() {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_COMUNA.SELECT_ALL")
