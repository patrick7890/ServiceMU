 ...
 */
@Stateless
@Path("clases.tipotransporte")
public class TipoTransporteFacadeREST {
    ...
    public Response create(@PathParam("tipo") String tipo) {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_TIPO_TRANS.INSERTAR")
    ...
    public Response edit(@PathParam("id") Long id, @PathParam("tipo") String tipo) {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_TIPO_TRANS.MODIFICAR")
    ...
    public Response remove(@PathParam("id") Long id) {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_TIPO_TRANS.ELIMINAR")
                .registerStoredProcedureParameter(1, Long.class,
                        ParameterMode.IN)
                .registerStoredProcedureParameter(2, Class.class,
                        ParameterMode.OUT)
    ...
    public Response find(@PathParam("id") Long id) {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_TIPO_TRANS.FIND")
                .registerStoredProcedureParameter(1, Long.class,
                        ParameterMode.IN)
                .registerStoredProcedureParameter(2, Class.class,
    ...
    public Response findAll() {
        StoredProcedureQuery query = em
                .createStoredProcedureQuery("PKG_MAIPOU_TIPO_TRANS.SELECT_ALL")
